...
import com.bus.mobileNoSerializer.MobileNoDeserializer;
import com.bus.mobileNoSerializer.MobileNoSerializer;
...
public class Owner {
	...
	private String name;
	 ...
	 @JsonSerialize(using = MobileNoSerializer.class)
	 @JsonDeserialize(using = MobileNoDeserializer.class)
